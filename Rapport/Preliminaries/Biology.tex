...
\caption{The RNA sequence {\tt AGCAGGCUAGCCGCU}. Note the bulging {\tt A}.}
\label{fig:bulge}
\end{figure}
\textbf{Interior Loop}\\
...
\caption{The RNA sequence {\tt AGCAGGCUAGCCGGCU}. Note the bulging {\tt A} and {\tt G} 
...
happen in DNA if the two strands of the DNA has been separated. Figure~\ref{fig:stem-loop} 
shows a stem loop.
